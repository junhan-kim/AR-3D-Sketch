...
public class PlaneManager : MonoBehaviour
{
    ...
    [SerializeField] AnchorBehaviour planeAnchor = null;
    [SerializeField] AnchorBehaviour midAirAnchor = null;
    [SerializeField] AnchorBehaviour placementAnchor = null;

    [SerializeField] GameObject planeObject = null;
    [SerializeField] GameObject midAirObject = null;
    [SerializeField] GameObject placementObject = null;
    ...
    public bool isTrackingStatusIsTrackedAndNormal()
    {
            ...
            switch (CurrentPlaneMode)
            {
                case PlaneMode.GROUND:
                    ...
                    if (TrackingStatusIsTrackedOrLimited)
                    {
                        ...
                        UtilityHelper.EnableRendererColliderCanvas(planeObject, true);
                ...
                case PlaneMode.PLACEMENT:
                    ...
                    if (TrackingStatusIsTrackedOrLimited)
                    {
                        ...
                        if (!this.productPlacement.IsPlaced || TouchHandler.DoubleTap)
                        {
                            ...
                            this.contentPositioningBehaviour.PositionContentAtPlaneAnchor(result);
                            UtilityHelper.EnableRendererColliderCanvas(placementObject, true);
                        }
    ...
    public void PlaceObjectInMidAir(Transform midAirTransform)
    {
        if (CurrentPlaneMode == PlaneMode.MIDAIR)
        {
            ...
            if (TrackingStatusIsTrackedAndNormal)
            {
                ...
                UtilityHelper.EnableRendererColliderCanvas(midAirObject, true);
